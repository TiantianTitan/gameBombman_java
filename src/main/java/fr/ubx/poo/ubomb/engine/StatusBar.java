...
public class StatusBar {
    ...
    public StatusBar(Group root, int sceneWidth, int sceneHeight, Game game,boolean mode) {
        // Status bar
        this.game = game;
        this.mode = mode;
        ...
        if(mode) {
            ...
            status.getChildren().addAll(live, bombs, range, key,score);
    ...
    public void update(Game game) {
        ...
        if(mode) scores.setText(""+ player.getScores());
    }
}
